...
> mocha lib/test
  ...
  api
    validateFile
      ✓ should validate a file (68ms)
      ✓ should pass properties (57ms)
      ✓ should pass pseudo-parameters (53ms)
      ✓ should reset validator state (46ms)
    validateJsonObject
      ✓ should validate an object (40ms)
  ...
  index
    CLI - functional tests
      ✓ no parameters (130ms)
      ✓ missing file parameter (123ms)
      ✓ validate simple yaml (301ms)
      ✓ validate parameter flag (299ms)
      ✓ validate importValue flag (312ms)
      ✓ validate numeric importValue flag (300ms)
      ✓ validate pseudo flag (296ms)
      ✓ validate pseudo + parameter flag (303ms)
      ✓ invalid pseudo flag throws 2 critical error (309ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (300ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (315ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (302ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (339ms)
      ✓ handle validation exceptions - non-verbose (247ms)
      ✓ handle validation exceptions - verbose (268ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (303ms)
      ✓ parameters of the List<Number> type should accept lists as values (297ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (118ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (49ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using mixed notation (41ms)
  ...
  validator
    validateJsonObject
      ✓ a valid (1.json) template should return an object with validTemplate = true, no crit errors (52ms)
      ✓ a valid (2.json) template should return an object with validTemplate = true, no crit errors (48ms)
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (54ms)
      ✓ a valid (4.json) template should return an object with validTemplate = true, no crit errors (47ms)
      ✓ 2 invalid resource types should return an object with validTemplate = false, 2 crit errors (41ms)
      ✓ 1 missing parameter type should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 invalid parameter type should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ missing section resources should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ empty section resources should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ 1 invalid resource reference should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ 1 invalid parameter reference should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 2 invalid Fn::Join's should return an object with validTemplate = false, 2 crit errors (43ms)
      ✓ 1 invalid Fn::GetAtt should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 invalid Fn::FindInMap should return an object with validTemplate = false, 1 crit errors (42ms)
      ✓ 1 invalid Ref within Parameters should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 1 invalid GetAZs parameter should return an object with validTemplate = false, 1 crit errors (56ms)
      ✓ 1 reference non AWS::Region GetAZs parameter should return an object with validTemplate = false, 1 warn errors (78ms)
    Fn::Join
      ✓ should error if it attempts to join anything but a list of values (42ms)
    Fn::Select JSON
      ✓ should pass validation, with flat list and intrinsic list (40ms)
      ✓ should pass validation with Parameter Collection (40ms)
      ✓ should error if index is greater than list size (41ms)
      ✓ should error if second element is not a list or a function (40ms)
      ✓ should error if first element is not a number or does not parse to a number (41ms)
      ✓ should error if first element is not defined or is null (39ms)
      ✓ should error if only one element as argument list (39ms)
      ✓ should error if second element is null or undefined (40ms)
      ✓ should error if second element does not resolve to a list (40ms)
      ✓ should error if first element does not resolve to a number (40ms)
      ✓ should error if first element attempts an invalid intrinsic function (42ms)
      ✓ should error if first element is anything other than non-array object, number or string (39ms)
      ✓ should error if second element attempts an invalid intrinsic function (39ms)
      ✓ should error if second element contains a list with null values (43ms)
    Fn::Select YAML
      ✓ should validate in yaml with literal and intrinic elements in array (43ms)
      ✓ should validate in yaml with Comma Separated List Param (48ms)
      ✓ should error if index is greater than list size (40ms)
      ✓ should error if second element is not a list or a function (40ms)
      ✓ should error if first element is not a number or does not parse to a number (40ms)
      ✓ should error if first element is not defined or is null (40ms)
      ✓ should error if only one element as argument list (41ms)
      ✓ should error if second element is null or undefined (44ms)
      ✓ should error if second element does not resolve to a list (41ms)
      ✓ should error if first element does not resolve to a number (41ms)
      ✓ should error if first element attempts an invalid intrinsic function (40ms)
      ✓ should error if first element is anything other than non-array object, number or string (41ms)
      ✓ should error if second element attempts an invalid intrinsic function (40ms)
      ✓ should error if second element contains a list with null values (44ms)
    Fn::Sub
      ✓ 3 valid Fn::Sub should return an object with validTemplate = true, 0 crit errors (48ms)
      ✓ a sub referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (40ms)
      ✓ a sub getatt an invalid resource should result in validTemplate = false, 2 crit errors, no warnings (45ms)
      ✓ a sub with nested intrinsic values should result in validTemplate = true, 0 crit errors, no warnings (51ms)
    Fn::ImportValue
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (48ms)
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (41ms)
      ✓ a valid Fn::ImportValue should return an object with validTemplate = true, 0 crit errors (41ms)
      ✓ an Fn::ImportValue with a correct override should return an object with validTemplate = true, 0 crit errors (40ms)
    Fn::GetAtt
      ✓ Fn::GetAtt for an arbitrary attribute on a custom resource should return a mock result (42ms)
      ✓ should pass validation where !GetAtt returns a list (43ms)
      ✓ should not pass validation where !GetAtt returns a list (41ms)
      ✓ should not pass validation with !GetAtt where attribute does not exist (41ms)
      ✓ should pass validation where !GetAtt returns some unexpected attribute for AWS::CloudFormation::Stack (39ms)
      ✓ should not pass validation with !GetAtt where the resource does not exist (40ms)
    conditions
      ✓ 1 invalid if condition arguments should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ 1 invalid if condition should return an object with validTemplate = false, 1 crit errors (47ms)
      ✓ 1 invalid condition value should return an object with validTemplate = false, 1 crit errors (70ms)
      ✓ 1 invalid condition value type should return an object with validTemplate = false, 1 crit errors (54ms)
      ✓ 1 valid condition value type should return an object with validTemplate = true, 0 crit errors (48ms)
    Fn::Split
...
{ info: [], warn: [], crit: [] }
    ...
    templateVersion
      ✓ 1 invalid template version should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 missing template version should return an object with validTemplate = true, 0 crit errors (41ms)
    propertyValidation
      ✓ 1 invalid arn property should return an object with validTemplate = false, 1 crit errors (41ms)
      ✓ 1 invalid property name of ResourceType should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 1 invalid property name of PropertyType should return an object with validTemplate = false, 1 crit errors (41ms)
      ✓ 1 invalid property name of Tag list should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ 1 string property should return an object with validTemplate = false, 1 crit errors (50ms)
      ✓ 1 missing propertyType property should return an object with validTemplate = false, 1 crit errors (50ms)
      ✓ 1 missing resourceType  property should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ 1 missing (via AWS::NoValue) property should return an object with validTemplate = false, 1 crit errors (42ms)
      ✓ 1 invalid boolean property should return an object with validTemplate = false, 1 crit errors (45ms)
      ✓ 4 invalid nested properties should return an object with validTemplate = false, 4 crit errors (43ms)
      ✓ a valid template with a Map property should return an object with validTemplate = true, no crit errors (41ms)
      ✓ an invalid template with a Map property should return an object with validTemplate = false, 1 crit error (41ms)
      ✓ a valid (valid_timestamp.yaml) template with a Timestamp should return an objcet with validTemplate = true (41ms)
      ✓ a (invalid_timestamp.yaml) template with an invalid Timestamp should return an objcet with validTemplate = false, 2 crit errors (41ms)
      ✓ a valid template with APIG string results in validTemplate = true, 0 crit error (47ms)
    validateYamlFile
      ✓ a valid (1.yaml) template should return an object with validTemplate = true, no crit errors (48ms)
      ✓ a valid (2.yaml) template should return an object with validTemplate = true, no crit errors (44ms)
      ✓ a valid (valid_minus_one_as_string.yaml) template should return an object with validTemplate = true, no crit errors (40ms)
    issues
      ✓ a valid ASG template with Tags property should return an object with validTemplate = true, no crit errors (50ms)
      ✓ both methods of defining a custom resource should result in validTemplate = true, no crit errors (41ms)
      ✓ numeric properties should result in validTemplate = true, no crit errors, no warn errors (48ms)
      ✓ IAM with ManagedPolicyName should result in validTemplate=true, no crit errors, no warn errors (40ms)
      ✓ Reference to RDS attribute validTemplate=true, no crit errors, no warn errors (41ms)
      ✓ if condition not working as expected, no crit errors, no warn errors (41ms)
      ✓ if condition not working as expected, 2 crit errors, no warn errors (41ms)
      ✓ a list of an extended parameter type should be properly mocked without causing an exception (42ms)
      ✓ a null property value should not cause an exception (39ms)
      ✓ Fn::Split should support function "Fn::ImportValue" (53ms)
      ✓ a template with properties containing nested aggregate types should be validated successfully (160ms)
      ✓ Issue #214 - SQS Queues now accept Tags (42ms)
      ✓ Issue #221 - Allow sub with split (40ms)
      ✓ Issue #212 - Ref does not account for resources that return ARNS (42ms)
    parameters-validation
      ✓ an unallowed parameter value provided at runtime gets rejected (40ms)
      ✓ an allowed parameter value provided at runtime gets allowed (42ms)
      ✓ an empty parameter value provided at runtime picks up the empty default (which will throw an error) (42ms)
      ✓ missing parameters should cause an error when guessParameters is set (43ms)
      ✓ parameters in guessParameters should be permitted to be guessed (40ms)
      ✓ List<AWS::EC2::AvailabilityZone::Name> should return a list (44ms)
      ✓ List<AWS::EC2::Image::Id> should return a list (40ms)
      ✓ List<AWS::EC2::Instance::Id> should return a list (65ms)
      ✓ List<AWS::EC2::SecurityGroup::GroupName> should return a list (62ms)
      ✓ List<AWS::EC2::SecurityGroup::Id> should return a list (42ms)
      ✓ List<AWS::EC2::Subnet::Id> should return a list (47ms)
      ✓ List<AWS::EC2::Volume::Id> should return a list (49ms)
      ✓ List<AWS::EC2::VPC::Id> should return a list (47ms)
      ✓ List<AWS::Route53::HostedZone::Id> should return a list (47ms)
    pseudo-parmeters
      ✓ defining an override for accountId should result in validTemplate = true, no crit errors, no warnings (40ms)
      ✓ using the pseudo parameter AWS::URLSuffix should result in validTemplate = true, no crit errors, no warnings (41ms)
      ✓ using the pseudo parameter AWS::Partition should result in validTemplate = true, no crit errors, no warnings (43ms)
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (109ms)
      ✓ should validate using custom resource attribute values for logical-names (109ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (108ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (108ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (142ms)
    output-references
      ✓ an output referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (41ms)
      ✓ an output referencing an valid resource should result in validTemplate = true, 0 crit errors, no warnings (40ms)
      ✓ a template with an exported output missing a Name should result in validTemplate = false, 1 crit error (42ms)
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (97ms)
      ✓ should be able to determine the type of every property of every propertytype (240ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (247ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (184ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (874ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (443ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (274ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (586ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (157ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (454ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (352ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (433ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (172ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (295ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (279ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (346ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (287ms)
      ✓ a template missing a required property should fail validation (159ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (486ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (483ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (86ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (84ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (524ms)
      ✓ a invalid APIGateway::Stage.MethodSettings type (sam_20161031_api_methodsettings_not_a_list.yaml) should invalidate successfully (486ms)
      ✓ a valid APIGateway::Stage.MethodSettings containing incomplete APIGateway::Stage.MethodSetting (sam_20161031_api_methodsettings_missing_required.yaml) should invalidate successfully (447ms)
      ✓ a valid template with Ref in Globals (sam_20161031_environment_ref.yaml) should validate successfully (87ms)
