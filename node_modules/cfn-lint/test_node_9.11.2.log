...
> mocha lib/test
  ...
  index
    CLI - functional tests
      ...
      ✓ validate parameter flag (233ms)
      ✓ validate importValue flag (216ms)
      ✓ validate numeric importValue flag (212ms)
      ✓ validate pseudo flag (216ms)
      ✓ validate pseudo + parameter flag (212ms)
      ✓ invalid pseudo flag throws 2 critical error (231ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (223ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (208ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (250ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (226ms)
      ✓ handle validation exceptions - non-verbose (193ms)
      ✓ handle validation exceptions - verbose (235ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (223ms)
      ✓ parameters of the List<Number> type should accept lists as values (227ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (48ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation
...
{ info: [], warn: [], crit: [] }
    ...
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (60ms)
      ✓ should validate using custom resource attribute values for logical-names (61ms)
      ...
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (85ms)
    output-references
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (88ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (125ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (88ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (452ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (244ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (155ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (300ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (84ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (245ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (188ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (226ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (124ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (206ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (150ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (173ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (170ms)
      ✓ a template missing a required property should fail validation (92ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (255ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (277ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (54ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (44ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (303ms)
      ✓ a invalid APIGateway::Stage.MethodSettings type (sam_20161031_api_methodsettings_not_a_list.yaml) should invalidate successfully (243ms)
      ✓ a valid APIGateway::Stage.MethodSettings containing incomplete APIGateway::Stage.MethodSetting (sam_20161031_api_methodsettings_missing_required.yaml) should invalidate successfully (245ms)
      ✓ a valid template with Ref in Globals (sam_20161031_environment_ref.yaml) should validate successfully (45ms)
