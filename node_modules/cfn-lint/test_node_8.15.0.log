...
> mocha lib/test
  ...
  index
    CLI - functional tests
      ✓ no parameters (101ms)
      ✓ missing file parameter (105ms)
      ✓ validate simple yaml (213ms)
      ✓ validate parameter flag (225ms)
      ✓ validate importValue flag (219ms)
      ✓ validate numeric importValue flag (224ms)
      ✓ validate pseudo flag (222ms)
      ✓ validate pseudo + parameter flag (234ms)
      ✓ invalid pseudo flag throws 2 critical error (215ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (207ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (207ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (226ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (217ms)
      ✓ handle validation exceptions - non-verbose (194ms)
      ✓ handle validation exceptions - verbose (248ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (227ms)
      ✓ parameters of the List<Number> type should accept lists as values (253ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (60ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (41ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using mixed notation (38ms)
  ...
  validator
    validateJsonObject
      ...
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (51ms)
      ✓ a valid (4.json) template should return an object with validTemplate = true, no crit errors (46ms)
...
{ info: [], warn: [], crit: [] }
    ...
    propertyValidation
      ...
      ✓ 1 invalid boolean property should return an object with validTemplate = false, 1 crit errors (39ms)
    ...
    issues
      ...
      ✓ IAM with ManagedPolicyName should result in validTemplate=true, no crit errors, no warn errors (39ms)
    ...
    pseudo-parmeters
      ...
      ✓ using the pseudo parameter AWS::Partition should result in validTemplate = true, no crit errors, no warnings (47ms)
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (90ms)
      ✓ should validate using custom resource attribute values for logical-names (64ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (64ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (58ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (75ms)
    output-references
    ...
    type checking coverage
      ...
      ✓ should be able to determine the type of every property of every propertytype (194ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (121ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (87ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (454ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (244ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (138ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (304ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (81ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (239ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (182ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (230ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (91ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (155ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (147ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (168ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (149ms)
      ✓ a template missing a required property should fail validation (84ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (262ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (267ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (44ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (45ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (280ms)
      ✓ a invalid APIGateway::Stage.MethodSettings type (sam_20161031_api_methodsettings_not_a_list.yaml) should invalidate successfully (236ms)
      ✓ a valid APIGateway::Stage.MethodSettings containing incomplete APIGateway::Stage.MethodSetting (sam_20161031_api_methodsettings_missing_required.yaml) should invalidate successfully (253ms)
      ✓ a valid template with Ref in Globals (sam_20161031_environment_ref.yaml) should validate successfully (46ms)
