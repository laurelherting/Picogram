...
function loadPluginFromDirectory(directory, options) {
    ...
    if (jetpackPlugin.exists('commands') === 'dir') {
        ...
        plugin.commands = plugin.commands.concat(ramda_1.map(function (file) { return command_loader_1.loadCommandFromFile(path.join(directory, 'commands', file)); }, commands));
    }
