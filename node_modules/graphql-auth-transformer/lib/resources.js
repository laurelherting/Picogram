...
var cognito_1 = require("cloudform-types/types/cognito");
...
var ResourceFactory = /** @class */ (function () {
    ...
    ResourceFactory.prototype.makeParams = function () {
        ...
        return _a = {},
            ...
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolName] = new cloudform_types_1.StringParameter({
                Description: 'The name of the user pool.',
                Default: 'AppSyncUserPool'
            }),
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolMobileClientName] = new cloudform_types_1.StringParameter({
                Description: 'The name of the native user pool client.',
                Default: 'CognitoNativeClient'
            }),
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolJSClientName] = new cloudform_types_1.StringParameter({
                Description: 'The name of the web user pool client.',
                Default: 'CognitoJSClient'
            }),
            _a[graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolRefreshTokenValidity] = new cloudform_types_1.NumberParameter({
    ...
    ResourceFactory.prototype.makeShouldCreateUserPoolCondition = function () {
        return cloudform_types_1.Fn.Equals(cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId), graphql_transformer_common_1.ResourceConstants.NONE);
    };
    /**
     * Outputs
     */
    ResourceFactory.prototype.makeNativeClientOutput = function () {
        return {
            ...
            Value: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.RESOURCES.AuthCognitoUserPoolNativeClientLogicalID), cloudform_types_1.Fn.Join(" ", ["See UserPool:", cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId)])),
            Export: {
                Name: cloudform_types_1.Fn.Join(':', [cloudform_types_1.Refs.StackName, "CognitoNativeClient"])
            }
        };
    };
    ResourceFactory.prototype.makeJSClientOutput = function () {
        return {
            ...
            Value: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.RESOURCES.AuthCognitoUserPoolJSClientLogicalID), cloudform_types_1.Fn.Join(" ", ["See UserPool:", cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId)])),
            Export: {
                Name: cloudform_types_1.Fn.Join(':', [cloudform_types_1.Refs.StackName, "CognitoJSClient"])
            }
        };
    };
    ResourceFactory.prototype.makeUserPoolOutput = function () {
        return {
            ...
            Value: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.RESOURCES.AuthCognitoUserPoolLogicalID), cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId)),
            Export: {
                Name: cloudform_types_1.Fn.Join(':', [cloudform_types_1.Refs.StackName, "CognitoUserPoolId"])
            }
        };
    };
    ResourceFactory.prototype.updateGraphQLAPIWithAuth = function (apiRecord) {
        return new graphQlApi_1.default(__assign({}, apiRecord.Properties, { Name: apiRecord.Properties.Name, AuthenticationType: 'AMAZON_COGNITO_USER_POOLS', UserPoolConfig: new graphQlApi_1.UserPoolConfig({
                UserPoolId: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.RESOURCES.AuthCognitoUserPoolLogicalID), cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId)),
    ...
    ResourceFactory.prototype.makeUserPool = function () {
        return new cognito_1.default.UserPool({
            UserPoolName: cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolName),
            Policies: {
    ...
    ResourceFactory.prototype.makeUserPoolNativeClient = function () {
        return new cognito_1.default.UserPoolClient({
            ClientName: cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolMobileClientName),
            UserPoolId: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.RESOURCES.AuthCognitoUserPoolLogicalID), cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId)),
            GenerateSecret: true,
            RefreshTokenValidity: cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolRefreshTokenValidity),
            ReadAttributes: [],
            WriteAttributes: []
        }).condition(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool);
    };
    ResourceFactory.prototype.makeUserPoolJSClient = function () {
        return new cognito_1.default.UserPoolClient({
            ClientName: cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolJSClientName),
            UserPoolId: cloudform_types_1.Fn.If(graphql_transformer_common_1.ResourceConstants.CONDITIONS.AuthShouldCreateUserPool, cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.RESOURCES.AuthCognitoUserPoolLogicalID), cloudform_types_1.Fn.Ref(graphql_transformer_common_1.ResourceConstants.PARAMETERS.AuthCognitoUserPoolId)),
