...
function splitStack(opts) {
    ...
    function mapResourcesToStack(template) {
        var resourceKeys = Object.keys(template.Resources);
        var resourceStackMap = {};
        ...
        for (var _a = 0, resourceKeys_2 = resourceKeys; _a < resourceKeys_2.length; _a++) {
            var resourceKey = resourceKeys_2[_a];
     ...
     */
    function collectTemplates(template, resourceToStackMap) {
    ...
    var stacks = collectTemplates(templateJson, resourceToStackMap);
