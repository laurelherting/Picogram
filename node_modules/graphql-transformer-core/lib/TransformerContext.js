...
var TransformerContext = /** @class */ (function () {
    ...
    TransformerContext.prototype.addInputExtension = function (obj) {
        ...
        this.nodeMap[oldNode.name.value] = __assign({}, oldNode, { directives: mergedDirs, fields: mergedFields });
    };
    /**
    ...
    TransformerContext.prototype.addUnionExtension = function (obj) {
        ...
        var oldTypeMap = oldTypes.reduce(function (acc, type) {
            var _a;
            return (__assign({}, acc, (_a = {}, _a[type.name.value] = true, _a)));
        }, {});
        var newTypes = obj.types || [];
        var mergedFields = oldTypes.slice();
        ...
        this.nodeMap[oldNode.name.value] = __assign({}, oldNode, { directives: mergedDirs, types: mergedFields });
    };
    /**
    ...
    TransformerContext.prototype.addEnumExtension = function (obj) {
        ...
        var mergedValues = oldValues.slice();
        ...
        this.nodeMap[oldNode.name.value] = __assign({}, oldNode, { directives: mergedDirs, values: mergedValues });
    };
    /**
    ...
    TransformerContext.prototype.putStackMapping = function (stackName, listOfRegex) {
        for (var _i = 0, listOfRegex_1 = listOfRegex; _i < listOfRegex_1.length; _i++) {
            var reg = listOfRegex_1[_i];
            this.stackMapping.set(reg.toLowerCase(), stackName);
        }
    };
    TransformerContext.prototype.addToStackMapping = function (stackName, regex) {
