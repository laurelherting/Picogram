...
var TransformFormatter = /** @class */ (function () {
    function TransformFormatter(opts) {
    ...
    TransformFormatter.prototype.format = function (ctx) {
        ...
        var nestedStacks = splitStack_1.default({
            ...
            defaultDependencies: [graphql_transformer_common_2.ResourceConstants.RESOURCES.GraphQLSchemaLogicalID]
        });
        return __assign({}, nestedStacks, resolversFunctionsAndSchema);
    };
    /**
    ...
    TransformFormatter.prototype.collectResolversFunctionsAndSchema = function (ctx) {
        ...
        for (var _i = 0, _b = Object.keys(templateResources); _i < _b.length; _i++) {
            ...
            if (resource.Type === 'AWS::AppSync::Resolver') {
                ...
                resolverMap = __assign({}, resolverMap, resourceResolverMap);
            }
            else if (resource.Type === 'AWS::Lambda::Function') {
                // TODO: We only use the one function for now. Generalize this.
                functionsMap = __assign({}, functionsMap, (_a = {}, _a[resourceName + ".zip"] = ctx.metadata.get('ElasticsearchPathToStreamingLambda'), _a));
            }
        }
