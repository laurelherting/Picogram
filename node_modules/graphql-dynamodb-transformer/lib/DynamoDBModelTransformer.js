...
var DynamoDBModelTransformer = /** @class */ (function (_super) {
    ...
    function DynamoDBModelTransformer() {
        ...
        _this.object = function (def, directive, ctx) {
            ...
            ctx.putStackMapping("" + def.name.value, [
            ...
            ctx.setResource(tableLogicalID, _this.resources.makeModelTable(typeName, undefined, undefined));
            ctx.setResource(iamRoleLogicalID, _this.resources.makeIAMRole(typeName));
            ctx.setResource(graphql_transformer_common_2.ModelResourceIDs.ModelTableDataSourceID(typeName), _this.resources.makeDynamoDBDataSource(tableLogicalID, iamRoleLogicalID, typeName));
